...
import 'package:quran_a_day/app/view/home_page.dart';
...
class _AppState extends State<App> {
  ...
  void initState() {
    super.initState();
    // Post-frame so Android Activity context is guaranteed ready
    WidgetsBinding.instance.addPostFrameCallback((_) {
      NotificationService.instance.init(
        onTap: (payload) {
          final parsed = NotificationPayload.fromPayloadString(payload);
          if (parsed != null) {
            debugPrint('Notification tapped: page ${parsed.pageNumber}');
            // navigation wiring goes here
          }
        },
      );
    });
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (_) => DailyAyahCubit()..init()),
        BlocProvider(create: (_) => RandomPageCubit()..getLastReadPage()),
      ],
      child: MaterialApp(
        title: 'Quran a Day',
...
//         ),
//         BlocProvider(
//           create: (_) => RandomPageCubit()..getLastReadPage(),
//         ),
//       ],
//       child: MaterialApp(
//         title: 'Quran a Day',
